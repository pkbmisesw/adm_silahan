            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo logo-dark">
                    <span class="logo-sm">
                        ...
                        <h5 style="display: inline-block;" class='text-white fw-bold mt-4'>Silahan Kawan</h5>
                    </span>
                    <span class="logo-lg">
                ...
                <a href="#" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="../../assets/images/logo-sm.png" alt="logo-sm-light" height="24">
                        <h5 style="display: inline-block;" class='text-white fw-bold mt-4'>Silahan Kawan</h5>
                    </span>
                    <span class="logo-lg">
                        <img src="../../assets/images/logo-light.png" alt="logo-light" class="mb-1" height="22">
                        <h5 style="display: inline-block;" class='text-white fw-bold mt-4'>Silahan Kawan</h5>
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="../m_user/profile.php"><i class="ri-user-line align-middle me-1"></i> Profile</a>
