...
<?php
$title = "Silahan Kawan | Hasil ";include('../head_table.php');
?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    $sql = $conn->prepare("SELECT m_surat.*, m_user.nama as nama_user FROM `m_surat` INNER JOIN `m_user` ON m_surat.user_id = m_user.id WHERE m_surat.status = 8 ORDER BY id DESC");
                                    $sql->execute([]);
