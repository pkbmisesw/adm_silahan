                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Data <?= $master; ?> Selesai Telaah</h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($data['berkas_serti'] == null) { ?>
                                                            Berkas Kosong
                                                        <?php }else{ ?>
                                                            <a href="../../images/<?= $data['berkas_serti']; ?>" target="_blank">Lihat Berkas</a>
                                                        <?php }?>
                                                    </td>

                                                    <td>
                                                        <?php if ($_SESSION['level_id'] == 3) { ?>
                                                            <a href="uploadSelesaiTelaah.php?id=<?= $data['id'] ?>" class="btn btn-light btn_update_operator" data-toggle="modal">✎</a>
                                                        <?php }  ?>
                                                    </td>
                                                </tr>
                                            <?php $count++;
