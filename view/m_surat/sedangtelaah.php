...
<?php
$title = "Silahan Kawan | Surat Sedang Ditelaah";
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Master
                                                <?= $master; ?></a></li>
                                        <li class="breadcrumb-item active"><?= $master; ?> Sedang Ditelaah</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Data <?= $master; ?> Sedang Ditelaah</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['level_id'] == 3) {
                                                $sql = $conn->prepare("SELECT m_surat.*, m_user.nama as nama_user FROM `m_surat` INNER JOIN `m_user` ON m_surat.user_id = m_user.id WHERE status=6 AND petugas_id=:petugas_id ORDER BY id DESC");
                                                    ...
                                                    <?php if ($_SESSION['level_id'] == 2) { ?>
                                                        <td>
                                                            <a class="btn btn-success"
                                                                href="../../controller/<?php echo $dba; ?>_controller.php?op=selesaitelaah&id=<?php echo $data['id'] ?>"
