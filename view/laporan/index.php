                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    $sql = $conn->prepare("SELECT * FROM `m_surat` WHERE DATE(`created_at`) BETWEEN '".date("Y-m-d", strtotime($tanggal))."' AND '".date("Y-m-d", strtotime($sd))."' ORDER BY id DESC");                                    $sql->execute();
                                    ...
                                    while($data=$sql->fetch()) {
                                        ...
                                        <tr>
                                            <td><?= $count; ?></td>
                                            <td><?= $data['nama'] . ' - ' . $data['des'] . ' - Dari : ' . $data['nama']; ?></td>
                                                <?php if(!$data['note']){ ?>
