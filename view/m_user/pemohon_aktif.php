...
if ($_SESSION['level_id'] != 1) {
    echo "<script>alert('Maaf! anda tidak bisa mengakses halaman ini '); document.location.href='$url_web/index.php'</script>";
    die();
}
...
<?php
$title = "Silahan Kawan | Pemohon Aktif";include('../head_table.php');
?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    $sql = $conn->prepare("SELECT * FROM `m_user` WHERE status_aktif=0 ORDER BY id DESC");
                                    $sql->execute();
